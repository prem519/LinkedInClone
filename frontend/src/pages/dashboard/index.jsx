...
import { createPost, deletePost, getAllComments, getAllPosts, incremenPostLike, postComment } from '@/config/redux/action/postAction';
                                 ...
                                 <div className={styles.singleCard_profileContainer}>
                                    ...
                                    <div>
                                       ...
                                       <div className={styles.optionContainer}>
                                          ...
                                          <div onClick={async () => {
                                             await dispatch(incremenPostLike({ post_Id: post._id }))
                                             dispatch(getAllPosts())
